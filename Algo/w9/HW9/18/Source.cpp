...
public:
	...
	//провер€ет не та же ли это точка
	bool IsEqual(Point point) {
		return x == point.x && y == point.y;
	}
	//¬озвращает рассто€ние от этой точки до интересующей нас
...
//ќпредел€ет угол между векторами
...
double FindShell(vector<Point> points) {
	...
	do{
		...
		//добавл€ю еЄ в ответ и удал€ю их спсика точек
